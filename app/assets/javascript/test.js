...
const app = new Vue({
    ...
    methods: {
        ...
        async addNewList(e) {
            ...
            newList.data.items = [];
            this.changeList(newList.data, this.lists.length, e);
        ...
        async changeListConfirm() {
            ...
            const newList = await axios.patch(`http://shoppinglist.test/api/lists/${this.curList.id}`, {
        ...
        async changeListCancel() {
            ...
            if(this.adding) {
                axios.delete(`http://shoppinglist.test/api/lists/${this.curList.id}`)
            }
            this.adding = false;
